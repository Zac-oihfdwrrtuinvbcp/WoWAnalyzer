...
function CoreRotationSection({ modules }: GuideProps<typeof CombatLogParser>) {
  return (
    ...
    >
      ...
      >
        <p>
          <Trans id="guide.rogue.outlaw.sections.coreRotation.finishers.summary">
            Finishers should typically be used at 1 below max combo points or higher. 
            Your primary finisher is <SpellLink id={SPELLS.DISPATCH} />.
            You want to maintain as close to possible 100% uptime on both <SpellLink id={SPELLS.BETWEEN_THE_EYES}/> 
            and <SpellLink id={SPELLS.SLICE_AND_DICE}/> buff. Prioritise refreshing <SpellLink id={SPELLS.BETWEEN_THE_EYES}/> when the debuff is about to drop,
            and <SpellLink id={SPELLS.SLICE_AND_DICE}/> when the debuff is under pandemic window (tooltip here maybe to explain pandemic).
          </Trans>
        </p>
        <p>
          When talented into <SpellLink id={TALENTS.GREENSKINS_WICKERS_TALENT}/> you will want 
          to cast <SpellLink id={SPELLS.BETWEEN_THE_EYES}/> as close to on cd as possible 
      ...
      >
        <p>
          <Trans id="guide.rogue.outlaw.sections.coreRotation.procs.summary">
            One of the most important rule about outlaw is to not waste procs (tooltip for rare exceptions).
          </Trans>
        </p>
        ...
        explanation={
          <p>
            <SpellLink id={SPELLS.OPPORTUNITY}/> procs are generated by <SpellLink id={SPELLS.SINISTER_STRIKE}/>  
            (and <SpellLink id={SPELLS.AMBUSH}/> since you are talented into <SpellLink id={TALENTS.HIDDEN_OPPORTUNITY_TALENT}/>),
            it is important to never cast a builder that would risk overwritting a proc and wasting it. 
          </p>
        }
        data={
          <PassFail
      ...
      />
        <p>
        <SpellLink id={TALENTS.AUDACITY_TALENT}/> procs are generated by <SpellLink id={SPELLS.PISTOL_SHOT}/>,
            it is important to never cast a <SpellLink id={SPELLS.PISTOL_SHOT}/> that would risk overwritting a proc and wasting it. 
        </p>
        <p>-- WIP -- Proc used / (proc wasted + potential overriden procs) efficiency bars akin to how 
          devastations evoker handles procs in damage efficiency section</p>
      </SubSection>
      ...
      >
        <p>
          <Trans id="guide.rogue.outlaw.sections.coreRotation.hoLoop.summary">
            When playing any <SpellLink id={TALENTS.HIDDEN_OPPORTUNITY_TALENT}/> build a very important concept 
            is to maintain the pistol shot {'>'} ambush "loop". The goal should be to press sinister strike as 
            little as possible, we achieve this following these simple rules:
            <ul>
              <li>
                Never cast <SpellLink id={SPELLS.SINISTER_STRIKE}/> while having a <SpellLink id={SPELLS.AUDACITY_TALENT_BUFF}/> or <SpellLink id={SPELLS.OPPORTUNITY}/> proc
              </li>
              <li>
                Never cast <SpellLink id={SPELLS.SINISTER_STRIKE}/> whith <SpellLink id={SPELLS.VANISH}/> or <SpellLink id ={TALENTS.SHADOW_DANCE_TALENT}/> cooldown is ready
              </li>
            </ul>
          </Trans>
        </p>
        <p>-- WIP -- you pressed sinister strike with procs 'x' times, you pressed sinister strike with vanish or dance ready 'x' times</p>
      </SubSection>
      ...
      >
        <p>
          <Trans id="guide.rogue.outlaw.sections.coreRotation.rollTheBones.summary">
            You should aim to maintain 100% uptime on your <SpellLink id={TALENTS.ROLL_THE_BONES_TALENT}/> buffs. 
            Roll if you do not have any <SpellLink id={TALENTS.ROLL_THE_BONES_TALENT}/> buff active or 
            reroll based on the conditions bellow:(HO only, this will change for kir builds)
            <ul>
              <li>
              ...
              <li>
                ...
                <SpellLink id={SPELLS.SKULL_AND_CROSSBONES}/> paired with <SpellLink id={SPELLS.GRAND_MELEE}/>
              </li>
            </ul>
          </Trans>
        </p>
        <p>-- WIP -- Uptime bar + find a way to display time spent when the user should have rolled and when 
          user pressed bad rerolls </p>
      </SubSection>
